...
public class RedBlackTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
    ...
    private void rotate(Node<T> child, Node<T> parent) throws IllegalArgumentException {
        ...
        if(child.parent.equals(parent)&&parent.leftChild.equals(child)) {
            ...
            throw new IllegalArgumentException("The two given node are not in relationship");
        }
    }
    ...
    RedBlackTree tree = new RedBlackTree();
        ...
        assertEquals("[5, 4, 7, 3, 6, 8, 2]", tree.root.toString());
    }
    ...
    public void test2() {
        ...
        assertEquals("[3, 2, 5, 4, 7, 6, 8]", tree.root.toString());
    }
    ...
    public void test3() {
        ...
        tree.insert(71);
        tree.rotate(tree.root.leftChild, tree.root);
        assertEquals("[78, 71, 91]",tree.root.toString());
    }
